...
(tar xvfz libevent-2.1.8-stable.tar.gz && cd libevent-2.1.8-stable && ./configure --prefix=$TARGETDIR && make clean && make -j8 && make install) >& out/event.out && pass || fail $HINT
